 ...
 */
@Entity
@Table(catalog = "evento_esportivos", schema = "", uniqueConstraints = {
...
public class Usuario implements Serializable {
    ...
    @JoinColumn(name = "resultado_idresultado", referencedColumnName = "idresultado")
    @ManyToOne
    private Resultado resultadoIdresultado;
    ...
    public Usuario(Integer idusuario, String login, String email) {
        this.idusuario = idusuario;
        this.login = login;
        this.email = email;
    }
    ...
    public Resultado getResultadoIdresultado() {
        return resultadoIdresultado;
    }

    public void setResultadoIdresultado(Resultado resultadoIdresultado) {
    ...
    public String toString() {
        return "br.eventoEsportivo.model.classe.Usuario[ idusuario=" + idusuario + " ]";
    }
